...
namespace pugaknSDK {
  ...
  void MeshParser::getMeshPositions()
  {
    ...
    for (int vertexPos = 0; vertexPos < nPositions; vertexPos++)
    {
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[vertexPos].v1 = std::stof(numString);
      numString.clear();
      while (!(*m_pointer == ';'))
      {
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[vertexPos].v2 = std::stof(numString);
      numString.clear();
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[vertexPos].v3 = std::stof(numString);
  ...
  void MeshParser::getMeshNormals()
  {
    ...
    for (int normalPos = 0; normalPos < nNormals; normalPos++)
    {
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[normalPos].n1 = std::stof(numString);
      numString.clear();
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[normalPos].n2 = std::stof(numString);
      numString.clear();
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[normalPos].n3 = std::stof(numString);
  ...
  void MeshParser::getMeshTextureCords()
  {
    ...
    for (int textCordsPos = 0; textCordsPos < nTextCords; textCordsPos++)//nTextCords
    {
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[textCordsPos].t1 = std::stof(numString);
      numString.clear();
      while (!(*m_pointer == ';'))
      {
        numString.push_back(*m_pointer);
      ...
      ++m_pointer;
      m_meshes.back().m_vbo[textCordsPos].t2 = std::stof(numString);
      numString.clear();
      ++m_pointer;
    }
  }
